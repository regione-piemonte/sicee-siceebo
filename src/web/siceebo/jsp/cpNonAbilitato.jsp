...
<s:include value="/jsp/userpanels/cpNonAbilitato_pUserInfoCustom.jsp"></s:include>
...
<!-- widget bKoAutenticazione -->
	<csiuicore:ajaxify id="p_pCenter" 
		...
		requestUri="/siceebo/base/main/cpNonAbilitato!handleBKoAutenticazione_CLICKED.do" 
