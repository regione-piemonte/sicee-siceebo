...
<fmt:setBundle basename="/it/csi/sicee/siceebo/presentation/siceebo/action/ricercaace/CpDocAggiuntivaAction" />
...
<s:form id="cpDocAggiuntiva" action="cpDocAggiuntiva" namespace="/base/ricercaAce" method="post">
...
<s:include value="/jsp/userpanels/cpDocAggiuntiva_pUserInfoCustom.jsp"></s:include>
...
<display:table name="appDatalistDocumentazioneAggiuntiva"  				
               ...
               summary="" 
decorator="it.csi.sicee.siceebo.presentation.decorator.ricercaace.CpDocAggiuntivaTblDocAggiuntivaCustomDecorator"               class="dataTable">
...
<s:if test="isWidgetVisible('cpDocAggiuntiva','btBackButton')" >
...
<!-- widget btBackButton -->
<s:submit name="widg_btBackButton" id="widg_btBackButton" method="handleBtBackButton_CLICKED"
	key="cpDocAggiuntiva.btBackButton.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpDocAggiuntiva','btBackButton')" />
