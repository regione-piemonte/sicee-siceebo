...
<div id="contentPanel">
	...
	<div id="p_wpDisabled" class="widgetsPanelBlock"><!-- startFragment:p_wpDisabled -->
	
	

<div class="widgetsPanel" id="wpDisabled">
	
	<customtag:widgetsPanel id="wpDisabledTbl" columns="2" tableStyleClass="formTable"
		summary="" 
		>
