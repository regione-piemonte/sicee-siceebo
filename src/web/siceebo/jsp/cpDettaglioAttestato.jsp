...
<fmt:setBundle basename="/it/csi/sicee/siceebo/presentation/siceebo/action/ricercaace/CpDettaglioAttestatoAction" />
...
<s:form id="cpDettaglioAttestato" action="cpDettaglioAttestato" namespace="/base/ricercaAce" method="post">
...
<s:if test="isWidgetVisible('cpDettaglioAttestato','bIndietro')" >
...
<s:submit name="widg_bIndietro" id="widg_bIndietro" method="handleBIndietro_CLICKED"
	key="cpDettaglioAttestato.bIndietro.label" cssClass="buttonWidget"
	disabled="isWidgetDisabled('cpDettaglioAttestato','bIndietro')" />
