...
/** 
 * This class represents the primary key of the SICEE_L_ANNULLAMENTO table.
 */
public class SiceeLAnnullamentoPk implements Serializable
{
	...
	/**
	 * Method 'SiceeLAnnullamentoPk'
	 * 
	 */
	public SiceeLAnnullamentoPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeLAnnullamentoPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeLAnnullamentoPk)) {
			return false;
		}
		
		final SiceeLAnnullamentoPk _cast = (SiceeLAnnullamentoPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceebo.business.dao.dto.SiceeLAnnullamentoPk: " );
