...
public class SiceeTTransazione2018DaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTTransazione2018>, SiceeTTransazione2018Dao
{
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET ID_TRANSAZIONE_2018 = ?, FK_CERTIFICATORE = ?, FK_STATO_TRANS_2018 = ?, XML_RT = EMPTY_CLOB(), S1_VALORE_TRANSAZIONE = ?, S1_TIPO_ID_VERSANTE = ?, S1_COD_ID_VERSANTE = ?, S1_ANAGRAFICA_VERSANTE = ?, S1_ID_TRANSAZIONE_MDP = ?, S1_DT_CREAZIONE_TRANSAZIONE = ?, S2_ID_INFORMATIVA_PSP = ?, S2_IDENTIFICATIVO_PSP = ?, S2_RAG_SOCIALE_PSP = ?, S2_DESCR_SERVIZIO_PSP = ?, S3_ID_IUV = ?, S3_DT_AVVIO_TRANSAZIONE = ?, DT_CHIUSURA_TRANSAZIONE = ?, OP_GETSTATOTRANS_FK_STATO = ?, OP_GETSTATOTRANS_DT = ? WHERE ID_TRANSAZIONE_2018 = ?",dto.getIdTransazione2018(),dto.getFkCertificatore(),dto.getFkStatoTrans2018(),dto.getXmlRt(),dto.getS1ValoreTransazione(),dto.getS1TipoIdVersante(),dto.getS1CodIdVersante(),dto.getS1AnagraficaVersante(),dto.getS1IdTransazioneMdp(),dto.getS1DtCreazioneTransazione(),dto.getS2IdInformativaPsp(),dto.getS2IdentificativoPsp(),dto.getS2RagSocialePsp(),dto.getS2DescrServizioPsp(),dto.getS3IdIuv(),dto.getS3DtAvvioTransazione(),dto.getDtChiusuraTransazione(),dto.getOpGetstatotransFkStato(),dto.getOpGetstatotransDt(),pk.getIdTransazione2018());
	}

	/** 
	 * Updates the OpGetstatotransFkStato and OpGetstatotransDt in the SICEE_T_TRANSAZIONE_2018 table.
	 */
	public void update(SiceeTTransazione2018Pk pk, Integer statoNew, Date dataAgg) throws SiceeTTransazione2018DaoException
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET OP_GETSTATOTRANS_FK_STATO = ?, OP_GETSTATOTRANS_DT = ? WHERE ID_TRANSAZIONE_2018 = ?",statoNew,dataAgg,pk.getIdTransazione2018());
	}

	/** 
	 * Updates the fk_stato_trans_2018 in the SICEE_T_TRANSAZIONE_2018 table.
	 */
	public void annullaTranazioniUnsuccessfull() throws SiceeTTransazione2018DaoException
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET FK_STATO_TRANS_2018 = "+Constants.ID_STATO_TRANS_MDP_NEW_ANNULLATO_BO+" WHERE OP_GETSTATOTRANS_FK_STATO = "+Constants.MDP_UNSUCCESSFULL+" AND FK_STATO_TRANS_2018 IN ("+Constants.ID_STATO_TRANS_MDP_NEW_AVVIO_TRANS+","+Constants.ID_STATO_TRANS_MDP_NEW_ATTESA_RT+")");
	}
	...
	{
		try {
			List<SiceeTTransazione2018> list = jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE ID_TRANSAZIONE_2018 = ?", this,idTransazione2018);
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE VALORE_TRANSAZIONE = ? ORDER BY VALORE_TRANSAZIONE", this,valoreTransazione);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE XML_RPT = ? ORDER BY XML_RPT", this,xmlRpt);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE DATA_RPT = ? ORDER BY DATA_RPT", this,dataRpt);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE DATA_RT = ? ORDER BY DATA_RT", this,dataRt);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE ID_TRANSAZIONE_MDP = ? ORDER BY ID_TRANSAZIONE_MDP", this,idTransazioneMdp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE ID_IUV = ? ORDER BY ID_IUV", this,idIuv);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " ORDER BY ID_TRANSAZIONE_2018", this);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE OP_GETSTATOTRANS_FK_STATO = ?", this,opGetstatotransFkStato);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE FK_STATO_TRANS_2018 = ?", this,fkStatoTrans2018);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE ID_TRANSAZIONE_2018 = ? ORDER BY ID_TRANSAZIONE_2018", this,idTransazione2018);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE FK_CERTIFICATORE = ? ORDER BY FK_CERTIFICATORE", this,fkCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE FK_CERTIFICATORE = ? AND FK_STATO_TRANS_2018 = ? ORDER BY ID_TRANSAZIONE_2018", this,fkCertificatore, fkStatoTrans2018);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE FK_STATO_TRANS_2018 = ? ORDER BY FK_STATO_TRANS_2018", this,fkStatoTrans2018);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	public List<SiceeTTransazione2018> findWhereS1ValoreTransazioneEquals(long s1ValoreTransazione) throws SiceeTTransazione2018DaoException
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_VALORE_TRANSAZIONE = ? ORDER BY S1_VALORE_TRANSAZIONE", this,s1ValoreTransazione);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_TIPO_ID_VERSANTE = ? ORDER BY S1_TIPO_ID_VERSANTE", this,s1TipoidVersante);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_COD_ID_VERSANTE = ? ORDER BY S1_COD_ID_VERSANTE", this,s1CodIdVersante);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_ANAGRAFICA_VERSANTE = ? ORDER BY S1_ANAGRAFICA_VERSANTE", this,s1AnagraficaVersante);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_ID_TRANSAZIONE_MDP = ? ORDER BY S1_ID_TRANSAZIONE_MDP", this,s1IdTransazioneMdp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S1_DT_CREAZIONE_TRANSAZIONE = ? ORDER BY S1_DT_CREAZIONE_TRANSAZIONE", this,s1DtCreazioneTransazione);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S2_ID_INFORMATIVA_PSP = ? ORDER BY S2_ID_INFORMATIVA_PSP", this,s2IdInformativaPsp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S2_IDENTIFICATIVO_PSP = ? ORDER BY S2_IDENTIFICATIVO_PSP", this,s2IdentificativoPsp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S2_RAG_SOCIALE_PSP = ? ORDER BY S2_RAG_SOCIALE_PSP", this,s2RagSocialePsp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S2_DESCR_SERVIZIO_PSP = ? ORDER BY S2_DESCR_SERVIZIO_PSP", this,s2DescrServizioPsp);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S3_ID_IUV = ? ORDER BY S3_ID_IUV", this,s3IdIuv);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE S3_DT_AVVIO_TRANSAZIONE = ? ORDER BY S3_DT_AVVIO_TRANSAZIONE", this,s3DtAvvioTransazione);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE DT_CHIUSURA_TRANSAZIONE = ? ORDER BY DT_CHIUSURA_TRANSAZIONE", this,dtChiusuraTransazione);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE XML_RT = ? ORDER BY XML_RT", this,xmlRt);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE OP_GETSTATOTRANS_FK_STATO = ? ORDER BY OP_GETSTATOTRANS_FK_STATO", this,opGetstatotransFkStato);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_TRANSAZIONE_2018, FK_CERTIFICATORE, FK_STATO_TRANS_2018, XML_RT, S1_VALORE_TRANSAZIONE, S1_TIPO_ID_VERSANTE, S1_COD_ID_VERSANTE, S1_ANAGRAFICA_VERSANTE, S1_ID_TRANSAZIONE_MDP, S1_DT_CREAZIONE_TRANSAZIONE, S2_ID_INFORMATIVA_PSP, S2_IDENTIFICATIVO_PSP, S2_RAG_SOCIALE_PSP, S2_DESCR_SERVIZIO_PSP, S3_ID_IUV, S3_DT_AVVIO_TRANSAZIONE, DT_CHIUSURA_TRANSAZIONE, OP_GETSTATOTRANS_FK_STATO, OP_GETSTATOTRANS_DT FROM " + getTableName() + " WHERE OP_GETSTATOTRANS_DT = ? ORDER BY OP_GETSTATOTRANS_DT", this,opGetstatotransDt);
		}
		catch (Exception e) {
			throw new SiceeTTransazione2018DaoException("Query failed", e);
		}
