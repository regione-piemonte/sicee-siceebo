...
/** 
 * This class represents the primary key of the SICEE_T_IMPORT_DATI_2015 table.
 */
public class SiceeTImportDati2015Pk implements Serializable
{
	...
	/**
	 * Method 'SiceeTImportDati2015Pk'
	 * 
	 */
	public SiceeTImportDati2015Pk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTImportDati2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTImportDati2015Pk)) {
			return false;
		}
		
		final SiceeTImportDati2015Pk _cast = (SiceeTImportDati2015Pk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTImportDati2015Pk: " );
