...
public class SiceeTActa implements Serializable
{
	...
	/**
	 * Method 'setIdProtocolloActa'
	 * 
	 * @param idProtocolloActa
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (idProtocolloActa == null ? _cast.idProtocolloActa != idProtocolloActa : !idProtocolloActa.equals( _cast.idProtocolloActa )) {
			return false;
		}
	...
	public int hashCode()
	{
		...
		if (idProtocolloActa != null) {
			_hashCode = 29 * _hashCode + idProtocolloActa.hashCode();
		}
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceebo.business.dao.dto.SiceeTActa: " );
		...
		ret.append( ", idProtocolloActa=" + idProtocolloActa );
		return ret.toString();
	}
