...
import it.csi.sicee.siceebo.business.dao.dto.SiceeTDatiGeneraliPk;
import it.csi.sicee.siceebo.business.dao.exceptions.SiceeTDatiGeneraliDaoException;
...
public class SiceeTDatiGeneraliDaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTDatiGenerali>, SiceeTDatiGeneraliDao
{
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET ID_CERTIFICATORE = ?, PROGR_CERTIFICATO = ?, ANNO = ?, DESC_TIPO_EDIFICIO = ?, FK_DEST_USO = ?, ANNO_COSTRUZIONE = ?, ANNO_ULT_RIST = ?, VOL_LORDO_RISCALDATO = ?, SUP_DISPERDENTE_TOT = ?, FATTORE_FORMA = ?, TRASM_OPACHE = ?, TRASM_TRASP = ?, ZONA_CLIMATICA = ?, GRADI_GIORNO = ?, SU = ?, EMISSIONI_SERRA = ?, ETTARI_BOSCO = ?, FLG_USO_PUBBLICO = ?, FK_CARATT_EDIFICIO = ?, NR_UM = ?, SUP_RISCALDATA = ?, SUP_RAFFRESCATA = ?, SUP_DISPERDENTE = ?, VOL_LORDO_RAFFRESCATO = ?, FK_OGGETTO_APE = ?, FK_DEST_USO_2015 = ?, FK_TIPO_RISTRUTTURAZ = ?, FK_TIPOL_EDILIZIA = ?, FK_TIPOL_COSTRUTTIVA = ?, FK_PROPRIETA_EDI = ? WHERE ID_CERTIFICATORE = ? AND PROGR_CERTIFICATO = ? AND ANNO = ?",dto.getIdCertificatore(),dto.getProgrCertificato(),dto.getAnno(),dto.getDescTipoEdificio(),dto.getFkDestUso(),dto.getAnnoCostruzione(),dto.getAnnoUltRist(),dto.getVolLordoRiscaldato(),dto.getSupDisperdenteTot(),dto.getFattoreForma(),dto.getTrasmOpache(),dto.getTrasmTrasp(),dto.getZonaClimatica(),dto.getGradiGiorno(),dto.getSu(),dto.getEmissioniSerra(),dto.getEttariBosco(),dto.getFlagUsoPubblico(),dto.getFkCarattEdificio(),dto.getNrUm(),dto.getSupRiscaldata(),dto.getSupRaffrescata(),dto.getSupDisperdente(),dto.getVolLordoRaffrescato(),dto.getFkOggettoApe(),dto.getFkDestUso2015(),dto.getFkTipoRistrutturaz(),dto.getFkTipolEdilizia(),dto.getFkTipolCostruttiva(),dto.getFkProprietaEdi(),pk.getIdCertificatore(),pk.getProgrCertificato(),pk.getAnno());
	}
	...
	{
		try {
			List<SiceeTDatiGenerali> list = jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? AND PROGR_CERTIFICATO = ? AND ANNO = ?", this,idCertificatore,progrCertificato,anno);
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_EDIFICIO = ?", this,fkEdificio);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_EDIFICIO = ? ORDER BY FK_EDIFICIO", this,fkEdificio);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_CARATT_EDIFICIO = ?", this,fkCarattEdificio);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " ORDER BY ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO", this);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? ORDER BY ID_CERTIFICATORE", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE PROGR_CERTIFICATO = ? ORDER BY PROGR_CERTIFICATO", this,progrCertificato);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ANNO = ? ORDER BY ANNO", this,anno);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE DESC_TIPO_EDIFICIO = ? ORDER BY DESC_TIPO_EDIFICIO", this,descTipoEdificio);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ANNO_COSTRUZIONE = ? ORDER BY ANNO_COSTRUZIONE", this,annoCostruzione);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ANNO_ULT_RIST = ? ORDER BY ANNO_ULT_RIST", this,annoUltRist);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE VOL_LORDO_RISCALDATO = ? ORDER BY VOL_LORDO_RISCALDATO", this,volLordoRiscaldato);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE SUP_DISPERDENTE_TOT = ? ORDER BY SUP_DISPERDENTE_TOT", this,supDisperdenteTot);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FATTORE_FORMA = ? ORDER BY FATTORE_FORMA", this,fattoreForma);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE TRASM_OPACHE = ? ORDER BY TRASM_OPACHE", this,trasmOpache);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE TRASM_TRASP = ? ORDER BY TRASM_TRASP", this,trasmTrasp);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ZONA_CLIMATICA = ? ORDER BY ZONA_CLIMATICA", this,zonaClimatica);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE GRADI_GIORNO = ? ORDER BY GRADI_GIORNO", this,gradiGiorno);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE SU = ? ORDER BY SU", this,su);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE EMISSIONI_SERRA = ? ORDER BY EMISSIONI_SERRA", this,emissioniSerra);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE ETTARI_BOSCO = ? ORDER BY ETTARI_BOSCO", this,ettariBosco);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FLG_USO_PUBBLICO = ? ORDER BY FLG_USO_PUBBLICO", this,flgUsoPubblico);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_CARATT_EDIFICIO = ? ORDER BY FK_CARATT_EDIFICIO", this,fkCarattEdificio);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE NR_UM = ? ORDER BY NR_UM", this,nrUm);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE SUP_RISCALDATA = ? ORDER BY SUP_RISCALDATA", this,supRiscaldata);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE SUP_RAFFRESCATA = ? ORDER BY SUP_RAFFRESCATA", this,supRaffrescata);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE SUP_DISPERDENTE = ? ORDER BY SUP_DISPERDENTE", this,supDisperdente);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE VOL_LORDO_RAFFRESCATO = ? ORDER BY VOL_LORDO_RAFFRESCATO", this,volLordoRaffrescato);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_OGGETTO_APE = ? ORDER BY FK_OGGETTO_APE", this,fkOggettoApe);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DESC_TIPO_EDIFICIO, FK_DEST_USO, ANNO_COSTRUZIONE, ANNO_ULT_RIST, VOL_LORDO_RISCALDATO, SUP_DISPERDENTE_TOT, FATTORE_FORMA, TRASM_OPACHE, TRASM_TRASP, ZONA_CLIMATICA, GRADI_GIORNO, SU, EMISSIONI_SERRA, ETTARI_BOSCO, FLG_USO_PUBBLICO, FK_CARATT_EDIFICIO, NR_UM, SUP_RISCALDATA, SUP_RAFFRESCATA, SUP_DISPERDENTE, VOL_LORDO_RAFFRESCATO, FK_OGGETTO_APE, FK_DEST_USO_2015, FK_TIPO_RISTRUTTURAZ, FK_TIPOL_EDILIZIA, FK_TIPOL_COSTRUTTIVA, FK_PROPRIETA_EDI FROM " + getTableName() + " WHERE FK_DEST_USO_2015 = ? ORDER BY FK_DEST_USO_2015", this,fkDestUso2015);
		}
		catch (Exception e) {
			throw new SiceeTDatiGeneraliDaoException("Query failed", e);
		}
