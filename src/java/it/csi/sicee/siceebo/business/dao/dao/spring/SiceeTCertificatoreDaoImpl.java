...
public class SiceeTCertificatoreDaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTCertificatore>, SiceeTCertificatoreDao
{
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET ID_CERTIFICATORE = ?, FK_AZIENDA = ?, FK_TITOLO = ?, NOME = ?, COGNOME = ?, CODICE_FISCALE = ?, ID_COMUNE_NASCITA = ?, DESC_COMUNE_NASCITA = ?, DT_NASCITA = ?, ID_PROV_NASCITA = ?, ID_INDIRIZZO = ?, DESC_PROV_NASCITA = ?, ID_REGIONE_NASCITA = ?, DESC_INDIRIZZO = ?, CAP = ?, DESC_REGIONE_NASCITA = ?, ID_COMUNE_RESIDENZA = ?, NUM_CIVICO_RESIDENZA = ?, DESC_COMUNE_RESIDENZA = ?, FLG_EDIFICI = ?, FLG_IMPIANTI = ?, FLG_VERIFICATO = ?, FLG_PAGAMENTO = ?, NOTE = ?, ID_PROV_RESIDENZA = ?, DT_ISCR_ELENCO = ?, DESC_PROV_RESIDENZA = ?, DT_SCADENZA_ELENCO = ?, ID_REGIONE_RESIDENZA = ?, NUM_TOT_ACE = ?, DESC_REGIONE_RESIDENZA = ?, ORDINE = ?, DESC_PROV_ORDINE = ?, NUM_ISCR_ALBO = ?, ID_PROV_ORDINE = ?, SETTORE = ?, SEZIONE = ?, TELEFONO = ?, DATA_ISCR_ALBO = ?, FAX = ?, CELL = ?, EMAIL = ?, NUM_CERTIFICATORE = ?, STATO_ESTERO = ?, FLG_CONSENSO_TEL = ?, FLG_CONSENSO_EMAIL = ?, FLG_CONSENSO_CELL = ?, EMAIL_PEC = ?, FLG_NEWSLETTER = ?, FLG_ESAME_SOSTENUTO = ?, SITO_WEB = ?, FLG_CANC_ELENCO = ?, FK_ISTRUZIONE = ?, FLG_AGG_DATI = ?, FLG_AGG_EMAIL = ?, DT_AGG_DATI = ?, DT_AGG_EMAIL = ?, ISCRITTO_ORDINE = ?, COMPETENZE_NAZIONALI = ?, ACCETTAZIONE_TECNICO = ?, DT_EMAIL_VERIFICA = ?, STATO_RES_ESTERO = ?, CITTA_ESTERA = ?, VIA_ESTERA = ?, CIVICO_ESTERO = ?, CAP_ESTERO = ?, FLG_RESIDENZA_ITALIA = ?, FK_BLOCCO_CERTIFICATORE = ?, DATA_BLOCCO_CERTIFICATORE = ?, NOTE_BLOCCO_CERTIFICATORE = ? WHERE ID_CERTIFICATORE = ?",dto.getIdCertificatore(),dto.getFkAzienda(),dto.getFkTitolo(),dto.getNome(),dto.getCognome(),dto.getCodiceFiscale(),dto.getIdComuneNascita(),dto.getDescComuneNascita(),dto.getDtNascita(),dto.getIdProvNascita(),dto.getIdIndirizzo(),dto.getDescProvNascita(),dto.getIdRegioneNascita(),dto.getDescIndirizzo(),dto.getCap(),dto.getDescRegioneNascita(),dto.getIdComuneResidenza(),dto.getNumCivicoResidenza(),dto.getDescComuneResidenza(),dto.getFlgEdifici(),dto.getFlgImpianti(),dto.getFlgVerificato(),dto.getFlgPagamento(),dto.getNote(),dto.getIdProvResidenza(),dto.getDtIscrElenco(),dto.getDescProvResidenza(),dto.getDtScadenzaElenco(),dto.getIdRegioneResidenza(),dto.getNumTotAce(),dto.getDescRegioneResidenza(),dto.getOrdine(),dto.getDescProvOrdine(),dto.getNumIscrAlbo(),dto.getIdProvOrdine(),dto.getSettore(),dto.getSezione(),dto.getTelefono(),dto.getDataIscrAlbo(),dto.getFax(),dto.getCell(),dto.getEmail(),dto.getNumCertificatore(),dto.getStatoEstero(),dto.getFlgConsensoTel(),dto.getFlgConsensoEmail(),dto.getFlgConsensoCell(),dto.getEmailPec(),dto.getFlgNewsletter(),dto.getFlgEsameSostenuto(),dto.getSitoWeb(),dto.getFlgCancElenco(),dto.getFkIstruzione(),dto.getFlgAggDati(),dto.getFlgAggEmail(),dto.getDtAggDati(),dto.getDtAggEmail(),dto.getIscrittoOrdine(),dto.getCompetenzeNazionali(),dto.getAccettazioneTecnico(),dto.getDtEmailVerifica(),dto.getStatoResEstero(),dto.getCittaEstera(),dto.getViaEstera(),dto.getCivicoEstero(),dto.getCapEstero(),dto.getFlgResidenzaItalia(),dto.getFkBloccoCertificatore(),dto.getDataBloccoCertificatore(),dto.getNoteBloccoCertificatore(),pk.getIdCertificatore());
	}
	...
	public SiceeTCertificatore mapRow(ResultSet rs, int row) throws SQLException
	{
		...
		dto.setDataBloccoCertificatore( rs.getTimestamp(69 ) );

		dto.setNoteBloccoCertificatore( rs.getString(70));
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE CODICE_FISCALE LIKE ?", this,codiceFiscale);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_ISTRUZIONE = ?", this,fkIstruzione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_TITOLO = ?", this,fkTitolo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_AZIENDA = ?", this,fkAzienda);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? ORDER BY ID_CERTIFICATORE", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_AZIENDA = ? ORDER BY FK_AZIENDA", this,fkAzienda);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_TITOLO = ? ORDER BY FK_TITOLO", this,fkTitolo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NOME = ? ORDER BY NOME", this,nome);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE COGNOME = ? ORDER BY COGNOME", this,cognome);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE CODICE_FISCALE LIKE ? ORDER BY CODICE_FISCALE", this,codiceFiscale);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE CODICE_FISCALE = ? ORDER BY CODICE_FISCALE", this,codiceFiscale);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_COMUNE_NASCITA = ? ORDER BY ID_COMUNE_NASCITA", this,idComuneNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_COMUNE_NASCITA = ? ORDER BY DESC_COMUNE_NASCITA", this,descComuneNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_NASCITA = ? ORDER BY DT_NASCITA", this,dtNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_PROV_NASCITA = ? ORDER BY ID_PROV_NASCITA", this,idProvNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_INDIRIZZO = ? ORDER BY ID_INDIRIZZO", this,idIndirizzo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_PROV_NASCITA = ? ORDER BY DESC_PROV_NASCITA", this,descProvNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_REGIONE_NASCITA = ? ORDER BY ID_REGIONE_NASCITA", this,idRegioneNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_INDIRIZZO = ? ORDER BY DESC_INDIRIZZO", this,descIndirizzo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE CAP = ? ORDER BY CAP", this,cap);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_REGIONE_NASCITA = ? ORDER BY DESC_REGIONE_NASCITA", this,descRegioneNascita);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_COMUNE_RESIDENZA = ? ORDER BY ID_COMUNE_RESIDENZA", this,idComuneResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NUM_CIVICO_RESIDENZA = ? ORDER BY NUM_CIVICO_RESIDENZA", this,numCivicoResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_COMUNE_RESIDENZA = ? ORDER BY DESC_COMUNE_RESIDENZA", this,descComuneResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_EDIFICI = ? ORDER BY FLG_EDIFICI", this,flgEdifici);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_IMPIANTI = ? ORDER BY FLG_IMPIANTI", this,flgImpianti);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_VERIFICATO = ? ORDER BY FLG_VERIFICATO", this,flgVerificato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_PAGAMENTO = ? ORDER BY FLG_PAGAMENTO", this,flgPagamento);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NOTE = ? ORDER BY NOTE", this,note);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_PROV_RESIDENZA = ? ORDER BY ID_PROV_RESIDENZA", this,idProvResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_ISCR_ELENCO = ? ORDER BY DT_ISCR_ELENCO", this,dtIscrElenco);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_PROV_RESIDENZA = ? ORDER BY DESC_PROV_RESIDENZA", this,descProvResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_SCADENZA_ELENCO = ? ORDER BY DT_SCADENZA_ELENCO", this,dtScadenzaElenco);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_REGIONE_RESIDENZA = ? ORDER BY ID_REGIONE_RESIDENZA", this,idRegioneResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NUM_TOT_ACE = ? ORDER BY NUM_TOT_ACE", this,numTotAce);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_REGIONE_RESIDENZA = ? ORDER BY DESC_REGIONE_RESIDENZA", this,descRegioneResidenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ORDINE = ? ORDER BY ORDINE", this,ordine);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DESC_PROV_ORDINE = ? ORDER BY DESC_PROV_ORDINE", this,descProvOrdine);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NUM_ISCR_ALBO = ? ORDER BY NUM_ISCR_ALBO", this,numIscrAlbo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ID_PROV_ORDINE = ? ORDER BY ID_PROV_ORDINE", this,idProvOrdine);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE SETTORE = ? ORDER BY SETTORE", this,settore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE SEZIONE = ? ORDER BY SEZIONE", this,sezione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE TELEFONO = ? ORDER BY TELEFONO", this,telefono);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DATA_ISCR_ALBO = ? ORDER BY DATA_ISCR_ALBO", this,dataIscrAlbo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FAX = ? ORDER BY FAX", this,fax);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE CELL = ? ORDER BY CELL", this,cell);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE EMAIL = ? ORDER BY EMAIL", this,email);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			List<SiceeTCertificatore> list = jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE NUM_CERTIFICATORE = ? ORDER BY NUM_CERTIFICATORE", this,numCertificatore);
			return list.size() == 0 ? null : list.get(0);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE STATO_ESTERO = ? ORDER BY STATO_ESTERO", this,statoEstero);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_CONSENSO_TEL = ? ORDER BY FLG_CONSENSO_TEL", this,flgConsensoTel);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_CONSENSO_EMAIL = ? ORDER BY FLG_CONSENSO_EMAIL", this,flgConsensoEmail);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_CONSENSO_CELL = ? ORDER BY FLG_CONSENSO_CELL", this,flgConsensoCell);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE EMAIL_PEC = ? ORDER BY EMAIL_PEC", this,emailPec);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_NEWSLETTER = ? ORDER BY FLG_NEWSLETTER", this,flgNewsletter);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_ESAME_SOSTENUTO = ? ORDER BY FLG_ESAME_SOSTENUTO", this,flgEsameSostenuto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE SITO_WEB = ? ORDER BY SITO_WEB", this,sitoWeb);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_CANC_ELENCO = ? ORDER BY FLG_CANC_ELENCO", this,flgCancElenco);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FK_ISTRUZIONE = ? ORDER BY FK_ISTRUZIONE", this,fkIstruzione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_AGG_DATI = ? ORDER BY FLG_AGG_DATI", this,flgAggDati);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE FLG_AGG_EMAIL = ? ORDER BY FLG_AGG_EMAIL", this,flgAggEmail);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_AGG_DATI = ? ORDER BY DT_AGG_DATI", this,dtAggDati);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_AGG_EMAIL = ? ORDER BY DT_AGG_EMAIL", this,dtAggEmail);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ISCRITTO_ORDINE = ? ORDER BY ISCRITTO_ORDINE", this,iscrittoOrdine);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE COMPETENZE_NAZIONALI = ? ORDER BY COMPETENZE_NAZIONALI", this,competenzeNazionali);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE ACCETTAZIONE_TECNICO = ? ORDER BY ACCETTAZIONE_TECNICO", this,accettazioneTecnico);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, FK_AZIENDA, FK_TITOLO, NOME, COGNOME, CODICE_FISCALE, ID_COMUNE_NASCITA, DESC_COMUNE_NASCITA, DT_NASCITA, ID_PROV_NASCITA, ID_INDIRIZZO, DESC_PROV_NASCITA, ID_REGIONE_NASCITA, DESC_INDIRIZZO, CAP, DESC_REGIONE_NASCITA, ID_COMUNE_RESIDENZA, NUM_CIVICO_RESIDENZA, DESC_COMUNE_RESIDENZA, FLG_EDIFICI, FLG_IMPIANTI, FLG_VERIFICATO, FLG_PAGAMENTO, NOTE, ID_PROV_RESIDENZA, DT_ISCR_ELENCO, DESC_PROV_RESIDENZA, DT_SCADENZA_ELENCO, ID_REGIONE_RESIDENZA, NUM_TOT_ACE, DESC_REGIONE_RESIDENZA, ORDINE, DESC_PROV_ORDINE, NUM_ISCR_ALBO, ID_PROV_ORDINE, SETTORE, SEZIONE, TELEFONO, DATA_ISCR_ALBO, FAX, CELL, EMAIL, NUM_CERTIFICATORE, STATO_ESTERO, FLG_CONSENSO_TEL, FLG_CONSENSO_EMAIL, FLG_CONSENSO_CELL, EMAIL_PEC, FLG_NEWSLETTER, FLG_ESAME_SOSTENUTO, SITO_WEB, FLG_CANC_ELENCO, FK_ISTRUZIONE, FLG_AGG_DATI, FLG_AGG_EMAIL, DT_AGG_DATI, DT_AGG_EMAIL, ISCRITTO_ORDINE, COMPETENZE_NAZIONALI, ACCETTAZIONE_TECNICO, DT_EMAIL_VERIFICA, STATO_RES_ESTERO, CITTA_ESTERA, VIA_ESTERA, CIVICO_ESTERO, CAP_ESTERO, FLG_RESIDENZA_ITALIA, FK_BLOCCO_CERTIFICATORE, DATA_BLOCCO_CERTIFICATORE, NOTE_BLOCCO_CERTIFICATORE FROM " + getTableName() + " WHERE DT_EMAIL_VERIFICA = ? ORDER BY DT_EMAIL_VERIFICA", this,dtEmailVerifica);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoreDaoException("Query failed", e);
		}
