...
/** 
 * This class represents the primary key of the SICEE_T_ALTRE_INFO table.
 */
public class SiceeTAltreInfoPk implements Serializable
{
	...
	/**
	 * Method 'SiceeTAltreInfoPk'
	 * 
	 */
	public SiceeTAltreInfoPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTAltreInfoPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTAltreInfoPk)) {
			return false;
		}
		
		final SiceeTAltreInfoPk _cast = (SiceeTAltreInfoPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTAltreInfoPk: " );
