...
public class SiceeTEnteformSl2015 implements Serializable
{
	/** 
	 * This attribute maps to the column ID_ENTE_SL in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected long idEnteSl;

	/** 
	 * This attribute maps to the column TIPO_SOGGETTO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String tipoSoggetto;

	/** 
	 * This attribute maps to the column DENOMINAZIONE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String denominazione;

	/** 
	 * This attribute maps to the column P_IVA in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String pIva;

	/** 
	 * This attribute maps to the column ID_REGIONE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String idRegione;

	/** 
	 * This attribute maps to the column DESC_REGIONE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String descRegione;

	/** 
	 * This attribute maps to the column ID_PROV in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String idProv;

	/** 
	 * This attribute maps to the column DESC_PROV in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String descProv;

	/** 
	 * This attribute maps to the column ID_COMUNE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String idComune;

	/** 
	 * This attribute maps to the column DESC_COMUNE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String descComune;

	/** 
	 * This attribute maps to the column ID_INDIRIZZO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String idIndirizzo;

	/** 
	 * This attribute maps to the column DESC_INDIRIZZO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String descIndirizzo;

	/** 
	 * This attribute maps to the column NUM_CIVICO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String numCivico;

	/** 
	 * This attribute maps to the column CAP in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String cap;

	/** 
	 * This attribute maps to the column REFERENTE in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String referente;

	/** 
	 * This attribute maps to the column TELEFONO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String telefono;

	/** 
	 * This attribute maps to the column CELL in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String cell;

	/** 
	 * This attribute maps to the column EMAIL in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String email;

	/** 
	 * This attribute maps to the column EMAIL_PEC in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String emailPec;

	/** 
	 * This attribute maps to the column FAX in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String fax;

	/** 
	 * This attribute maps to the column SITO_WEB in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String sitoWeb;

	/** 
	 * This attribute maps to the column BASE64_LOGO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String base64Logo;

	/** 
	 * This attribute maps to the column PARAMETRI_LOGO in the SICEE_T_ENTEFORM_SL_2015 table.
	 */
	protected String parametriLogo;

	/**
	 * Method 'SiceeTEnteformativo2015'
	 * 
	 */
	public SiceeTEnteformSl2015()
	{
	}
	...
	/**
	 * Method 'setParametriLogo'
	 * 
	 * @param parametriLogo
	 */
	public void setParametriLogo(String parametriLogo)
	{
		this.parametriLogo = parametriLogo;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTEnteformSl2015)) {
			return false;
		}
		
		final SiceeTEnteformSl2015 _cast = (SiceeTEnteformSl2015) _other;
		...
		if (pIva == null ? _cast.pIva != pIva : !pIva.equals( _cast.pIva )) {
			return false;
		}
	...
	public int hashCode()
	{
		...
		if (pIva != null) {
			_hashCode = 29 * _hashCode + pIva.hashCode();
		}
	 ...
	 */
	public SiceeTEnteformSl2015Pk createPk()
	{
		return new SiceeTEnteformSl2015Pk(idEnteSl);
	}
