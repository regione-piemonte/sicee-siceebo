...
/** 
 * This class represents the primary key of the SICEE_T_ACTA table.
 */
public class SiceeTActaPk implements Serializable
{
	 ...
	 * @param anno
	 */
	public SiceeTActaPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTActaPk)) {
			return false;
		}
		
		final SiceeTActaPk _cast = (SiceeTActaPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceebo.business.dao.dto.SiceeTActaPk: " );
