 ...
 */
public class SiceeTImpdatiXml2015Pk implements Serializable
{
	 ...
	 * @param anno
	 */
	public SiceeTImpdatiXml2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTImpdatiXml2015Pk)) {
			return false;
		}
		
		final SiceeTImpdatiXml2015Pk _cast = (SiceeTImpdatiXml2015Pk) _other;
