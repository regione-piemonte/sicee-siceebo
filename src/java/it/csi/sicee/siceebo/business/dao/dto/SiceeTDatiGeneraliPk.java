...
/** 
 * This class represents the primary key of the SICEE_T_DATI_GENERALI table.
 */
public class SiceeTDatiGeneraliPk implements Serializable
{
	 ...
	 * @param anno
	 */
	public SiceeTDatiGeneraliPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTDatiGeneraliPk)) {
			return false;
		}
		
		final SiceeTDatiGeneraliPk _cast = (SiceeTDatiGeneraliPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTDatiGeneraliPk: " );
