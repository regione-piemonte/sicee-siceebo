...
/** 
 * This class represents the primary key of the SICEE_T_EXPORT_BO table.
 */
public class SiceeTExportBoPk implements Serializable
{
	...
	/**
	 * Method 'SiceeTExportBoPk'
	 * 
	 */
	public SiceeTExportBoPk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTExportBoPk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTExportBoPk)) {
			return false;
		}
		
		final SiceeTExportBoPk _cast = (SiceeTExportBoPk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceebo.business.dao.dto.SiceeTExportBoPk: " );
