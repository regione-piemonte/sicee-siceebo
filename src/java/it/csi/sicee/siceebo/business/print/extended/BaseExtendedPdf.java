...
public abstract class BaseExtendedPdf {
	...
	/** The 16 red font. */
	protected Font b16redFont = FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD, new Color(0xFF, 0x00, 0x00));
	protected Font bi16redFont = FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLDITALIC, new Color(0xFF, 0x00, 0x00));
	
	/** The 14 font. */
	protected Font n14Font = new Font(Font.HELVETICA, 14, Font.NORMAL);
	protected Font b14Font = new Font(Font.HELVETICA, 14, Font.BOLD);
	protected Font i14Font = new Font(Font.HELVETICA, 14, Font.ITALIC);
	protected Font bi14Font = new Font(Font.HELVETICA, 14, Font.BOLDITALIC);

	/** The 13 font. */
	protected Font n13Font = new Font(Font.HELVETICA, 13, Font.NORMAL);
	protected Font b13Font = new Font(Font.HELVETICA, 13, Font.BOLD);
	protected Font i13Font = new Font(Font.HELVETICA, 13, Font.ITALIC);
	protected Font bi13Font = new Font(Font.HELVETICA, 13, Font.BOLDITALIC);

	/** The 12 font. */
	protected Font n12Font = new Font(Font.HELVETICA, 12, Font.NORMAL);
	protected Font b12Font = new Font(Font.HELVETICA, 12, Font.BOLD);
	protected Font i12Font = new Font(Font.HELVETICA, 12, Font.ITALIC);
	protected Font bi12Font = new Font(Font.HELVETICA, 12, Font.BOLDITALIC);

	/** The 11 font. */
	protected Font n11Font = new Font(Font.HELVETICA, 11, Font.NORMAL);
	protected Font b11Font = new Font(Font.HELVETICA, 11, Font.BOLD);
	protected Font i11Font = new Font(Font.HELVETICA, 11, Font.ITALIC);
	protected Font bi11Font = new Font(Font.HELVETICA, 11, Font.BOLDITALIC);

	/** The 10 font. */
	protected Font n10Font = new Font(Font.HELVETICA, 10, Font.NORMAL);
	protected Font b10Font = new Font(Font.HELVETICA, 10, Font.BOLD);
	protected Font i10Font = new Font(Font.HELVETICA, 10, Font.ITALIC);
	protected Font bi10Font = new Font(Font.HELVETICA, 10, Font.BOLDITALIC);

	/** The 9 font. */
	protected Font n9Font = new Font(Font.HELVETICA, 9, Font.NORMAL);
	protected Font b9Font = new Font(Font.HELVETICA, 9, Font.BOLD);
	protected Font i9Font = new Font(Font.HELVETICA, 9, Font.ITALIC);
	protected Font bi9Font = new Font(Font.HELVETICA, 9, Font.BOLDITALIC);

	/** The 8 font. */
	protected Font n8Font = new Font(Font.HELVETICA, 8, Font.NORMAL);
	protected Font b8Font = new Font(Font.HELVETICA, 8, Font.BOLD);
	protected Font i8Font = new Font(Font.HELVETICA, 8, Font.ITALIC);
	protected Font bi8Font = new Font(Font.HELVETICA, 8, Font.BOLDITALIC);
	...
	public abstract ByteArrayInputStream stampaModulo(GenericDto dati,
			//PdfReader reader, 
			String sfondo, boolean foto) throws IOException, DocumentException;
