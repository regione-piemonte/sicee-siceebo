...
public class SecurityHelper {
	...
	protected it.csi.sicee.siceebo.dto.UserInfo getCurrentUserInfo(Map session) throws BEException {
		it.csi.sicee.siceebo.dto.UserInfo userInfo = (it.csi.sicee.siceebo.dto.UserInfo) session
	...
	public static final Application IRIDE2_APPLICATION = new Application("SICEEBO");
	...
	public boolean verifyCurrentUserForUC(Map session, String useCaseCode) throws BEException {
		...
		try {
			it.csi.sicee.siceebo.dto.UserInfo currentUserInfo = getCurrentUserInfo(session);
	...
	public boolean customCheckIsAbilVerificaMdp(Map session) throws BEException {
		/*PROTECTED REGION ID(R-373944243) ENABLED START*//// inserire qui il codice del controllo custom
		try {
			return true;
		} catch (Exception ex) {
			LOG.error("[SecurityHelper::customCheckIsAbilVerificaMdp] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckIsAbilVerificaMdp", ex);
		}
		/*PROTECTED REGION END*/
	}
	public boolean customCheckIsAbilRecuperaRTMdp(Map session) throws BEException {
		/*PROTECTED REGION ID(R-1722433719) ENABLED START*//// inserire qui il codice del controllo custom
		try {
			return true;
		} catch (Exception ex) {
			LOG.error("[SecurityHelper::customCheckIsAbilRecuperaRTMdp] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckIsAbilRecuperaRTMdp", ex);
		}
		/*PROTECTED REGION END*/
	}
	public boolean customCheckIsAbilRecuperaIndex(Map session) throws BEException {
		/*PROTECTED REGION ID(R-1729948700) ENABLED START*//// inserire qui il codice del controllo custom
		try {
			return true;
		} catch (Exception ex) {
			LOG.error("[SecurityHelper::customCheckIsAbilRecuperaIndex] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckIsAbilRecuperaIndex", ex);
		}
		/*PROTECTED REGION END*/
	}
	public boolean customCheckIsAbilVisualizzaIndex(Map session) throws BEException {
		/*PROTECTED REGION ID(R-1357008523) ENABLED START*//// inserire qui il codice del controllo custom
		try {
			return true;
		} catch (Exception ex) {
			LOG.error("[SecurityHelper::customCheckIsAbilVisualizzaIndex] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckIsAbilVisualizzaIndex", ex);
		}
		/*PROTECTED REGION END*/
	}
	public boolean customCheckIsAbilRisolvereActa(Map session) throws BEException {
		/*PROTECTED REGION ID(R1340467493) ENABLED START*/ /// inserire qui il codice del controllo custom
		try {
			return true;
		} catch (Exception ex) {
			LOG.error("[SecurityHelper::customCheckIsAbilRisolvereActa] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckIsAbilRisolvereActa", ex);
		}
		/*PROTECTED REGION END*/
	}
	...
	public boolean customCheckVerificaCodiceFiscale(Map session) throws BEException {
		...
		try {
			...
			if (enteCf != null)
				...
				return false;
			/*
			 String[] codiciFiscaliAmmessi = getMiscMgr().getParametro(
			 Constants.CF_ENTI_FORMATIVI_ABILITATI).split(",");
	...
	public boolean customCheckVerificaCodiceFiscale2(Map session) throws BEException {
		/*PROTECTED REGION ID(R225382684) ENABLED START*//// inserire qui il codice del controllo custom
		try {
			String codiceFiscale = getCurrentUser(session).getCodFiscale();
			LOG.debug("\n\n\n>>>>>>> codiceFiscale = " + codiceFiscale);
			...
			LOG.error("[SecurityHelper::customCheckVerificaCodiceFiscale2] Errore durante l'esecuzione del metodo", ex);
			throw new BEException("Errore durante l'esecuzione del metodo customCheckVerificaCodiceFiscale2", ex);
		}
		/*PROTECTED REGION END*/
	}
