 ...
 * logica di business associata alla Schermata [cpRicercaCertificatoriAdv]
 */
@Validation
public class CpRicercaCertificatoriAdvModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDataelencoTipoCorsi'
	 * @param value
	 * @generated
	 */

	public void setAppDataelencoTipoCorsi(
			java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica> value) {
		getSession().put("appDataelencoTipoCorsi", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataelencoTipoCorsi'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica> getAppDataelencoTipoCorsi() {
		return (java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica>) (getSession()
				.get("appDataelencoTipoCorsi"));
	}
