 ...
 * logica di business associata alla Schermata [cpDocAggiuntiva]
 */
@Validation
public class CpDocAggiuntivaModel extends BaseSessionAwareDTO {
	...
	public void setAppDatadocumentoAggiuntivo(it.csi.sicee.siceebo.dto.ace.DocumentoAggiuntivo value) {
	 ...
	 * @generated
	 */
	public it.csi.sicee.siceebo.dto.ace.DocumentoAggiuntivo getAppDatadocumentoAggiuntivo() {
		return (it.csi.sicee.siceebo.dto.ace.DocumentoAggiuntivo) (getSession().get("appDatadocumentoAggiuntivo"));
	}
