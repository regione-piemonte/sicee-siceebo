 ...
 * logica di business associata alla Schermata [cpDettaglioCorso]
 */
@Validation
public class CpDettaglioCorsoModel extends BaseSessionAwareDTO {
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDataelencoTipologieCorsi'
	 * @param value
	 * @generated
	 */

	public void setAppDataelencoTipologieCorsi(
			java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica> value) {
		getSession().put("appDataelencoTipologieCorsi", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDataelencoTipologieCorsi'
	 * @generated
	 */
	public java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica> getAppDataelencoTipologieCorsi() {
		return (java.util.ArrayList<it.csi.sicee.siceebo.dto.entiformativi.Decodifica>) (getSession()
				.get("appDataelencoTipologieCorsi"));
	}
