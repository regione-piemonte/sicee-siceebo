...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercacertificatori.states.CpRicercaCertificatoriScreenStates;
...
/**
 * CpRicercaCertificatoriAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRicercaCertificatoriAction extends AbstractCPAction<CpRicercaCertificatoriModel>
		implements
			Preparable,
			ModelDriven<CpRicercaCertificatoriModel> {
	 ...
	 * strato di business.
	 */
	private CpRicercaCertificatoriModel model;
	 ...
	 * strato di business.
	 */
	public CpRicercaCertificatoriModel getModel() {
		return model;
	}
	...
	public void setModel(CpRicercaCertificatoriModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRicercaCertificatoriModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRicercaCertificatori";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercacertificatori.CpRicercaCertificatoriModel.class;
	}
	...
	public String handleCbRegione_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatori", "cbRegione", "VALUE_CHANGED");
	...
	public String handleCbProvincia_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatori", "cbProvincia", "VALUE_CHANGED");
	...
	public String handleBRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatori", "bRicerca", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R894766833) ENABLED START*/
