...
import it.csi.sicee.siceebo.dto.ricercacertificatori.CpRisultatoCertificatoriAdvModel;
...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercacertificatori.states.CpRisultatoCertificatoriAdvScreenStates;
...
/**
 * CpRisultatoCertificatoriAdvAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRisultatoCertificatoriAdvAction extends AbstractCPAction<CpRisultatoCertificatoriAdvModel>
		implements
			Preparable,
			ModelDriven<CpRisultatoCertificatoriAdvModel> {
	 ...
	 * strato di business.
	 */
	private CpRisultatoCertificatoriAdvModel model;
	 ...
	 * strato di business.
	 */
	public CpRisultatoCertificatoriAdvModel getModel() {
		return model;
	}
	...
	public void setModel(CpRisultatoCertificatoriAdvModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRisultatoCertificatoriAdvModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRisultatoCertificatoriAdv";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercacertificatori.CpRisultatoCertificatoriAdvModel.class;
	}
	...
	public String handleBtnBloccaCert_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatoriadv", "btnBloccaCert", "CLICKED");
	...
	public String handleBNuovaRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatoriadv", "bNuovaRicerca", "CLICKED");
	...
	public String handleBAffinaRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatoriadv", "bAffinaRicerca", "CLICKED");

	}

	/**
	 * Gestione dell'evento CLICKED sul widget [bVisualizzaDettaglio]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBVisualizzaDettaglio_CLICKED() throws CommandExecutionException {

		return handleEventInternal("ricercacertificatori", "cprisultatocertificatoriadv", "bVisualizzaDettaglio",
				"CLICKED");
	...
	public String handleScarica_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatoriadv", "scarica", "CLICKED");
	...
	public String provideTblRisultatoCertificatori_DATASET() throws CommandExecutionException {
		...
		return provideDataInternal("appDatacertificatoreList", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1728749354) ENABLED START*/
