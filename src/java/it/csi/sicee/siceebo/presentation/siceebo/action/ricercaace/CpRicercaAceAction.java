...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercaace.states.CpRicercaAceScreenStates;
...
public class CpRicercaAceAction extends AbstractCPAction<CpRicercaAceModel>
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercaace.CpRicercaAceModel.class;
	}
	...
	public String handleBRicercaByCodiceNav_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercaace", "cpricercaace", "bRicercaByCodiceNav", "CLICKED");
	...
	public String handleCbProvincia_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercaace", "cpricercaace", "cbProvincia", "VALUE_CHANGED");

	}

	/**
	 * Gestione dell'evento VALUE_CHANGED sul widget [rbIsOld]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleRbIsOld_VALUE_CHANGED() throws CommandExecutionException {

		return handleEventInternal("ricercaace", "cpricercaace", "rbIsOld", "VALUE_CHANGED");
	...
	public String handleBRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercaace", "cpricercaace", "bRicerca", "CLICKED");
	...
	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbRicAceClasse.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbRicAceClasse_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDataclasseEnergetica", "", false, false);
	}

	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbRicAceDestUso.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbRicAceDestUso_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDatadestinazioneUso", "", false, false);
	}

	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbRicAceMotRilascio.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbRicAceMotRilascio_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDatamotivazioneRilascio", "", false, false);
	}
