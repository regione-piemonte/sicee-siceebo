...
import it.csi.sicee.siceebo.dto.main.CpDisabledModel;
...
import it.csi.sicee.siceebo.presentation.siceebo.action.main.states.CpDisabledScreenStates;
...
/**
 * CpDisabledAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpDisabledAction extends AbstractCPAction<CpDisabledModel>
		implements
			Preparable,
			ModelDriven<CpDisabledModel> {
	 ...
	 * strato di business.
	 */
	public CpDisabledModel getModel() {
		return model;
	}
	...
	public void setModel(CpDisabledModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpDisabled";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.main.CpDisabledModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1564647318) ENABLED START*/
