...
import it.csi.sicee.siceebo.dto.ricercacertificatori.CpRisultatoCertificatoriModel;
...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercacertificatori.states.CpRisultatoCertificatoriScreenStates;
...
/**
 * CpRisultatoCertificatoriAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRisultatoCertificatoriAction extends AbstractCPAction<CpRisultatoCertificatoriModel>
		implements
			Preparable,
			ModelDriven<CpRisultatoCertificatoriModel> {
	 ...
	 * strato di business.
	 */
	private CpRisultatoCertificatoriModel model;
	 ...
	 * strato di business.
	 */
	public CpRisultatoCertificatoriModel getModel() {
		return model;
	}
	...
	public void setModel(CpRisultatoCertificatoriModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRisultatoCertificatoriModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRisultatoCertificatori";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercacertificatori.CpRisultatoCertificatoriModel.class;
	}
	...
	public String handleBNuovaRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatori", "bNuovaRicerca", "CLICKED");
	...
	public String handleBAffinaRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatori", "bAffinaRicerca", "CLICKED");
	...
	public String handleScarica_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cprisultatocertificatori", "scarica", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-821231563) ENABLED START*/
