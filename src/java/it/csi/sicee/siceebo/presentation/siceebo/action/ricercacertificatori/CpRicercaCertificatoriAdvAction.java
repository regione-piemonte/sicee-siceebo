...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercacertificatori.states.CpRicercaCertificatoriAdvScreenStates;
...
/**
 * CpRicercaCertificatoriAdvAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRicercaCertificatoriAdvAction extends AbstractCPAction<CpRicercaCertificatoriAdvModel>
		implements
			Preparable,
			ModelDriven<CpRicercaCertificatoriAdvModel> {
	 ...
	 * strato di business.
	 */
	private CpRicercaCertificatoriAdvModel model;
	 ...
	 * strato di business.
	 */
	public CpRicercaCertificatoriAdvModel getModel() {
		return model;
	}
	...
	public void setModel(CpRicercaCertificatoriAdvModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRicercaCertificatoriAdvModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRicercaCertificatoriAdv";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercacertificatori.CpRicercaCertificatoriAdvModel.class;
	}
	...
	/**
	 * Gestione dell'evento VALUE_CHANGED sul widget [cbRegione]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleCbRegione_VALUE_CHANGED() throws CommandExecutionException {

		return handleEventInternal("ricercacertificatori", "cpricercacertificatoriadv", "cbRegione", "VALUE_CHANGED");
	...
	public String handleCbProvincia_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatoriadv", "cbProvincia", "VALUE_CHANGED");
	...
	public String handleBRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatoriadv", "bRicerca", "CLICKED");
	...
	public String handleBNuovaRicerca_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercacertificatori", "cpricercacertificatoriadv", "bNuovaRicerca", "CLICKED");
	 ...
	 * al data-binding relativo al dataset DATASET del widget cbRegione.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbRegione_DATASET() throws CommandExecutionException {
	...
	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbTitolo.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbTitolo_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDatatitoli", "", false, false);
	}

	/**
	 * Prepara l'input stream referenziato dal result "provideData" con i valori relativi 
	 * al data-binding relativo al dataset DATASET del widget cbTipoCorso.
	 * @return sempre il result "provideData"
	 */
	@SkipValidation
	@FatClientOnly
	public String provideCbTipoCorso_DATASET() throws CommandExecutionException {

		return provideDataInternal("appDataelencoTipoCorsi", "", false, false);
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R878708890) ENABLED START*/
