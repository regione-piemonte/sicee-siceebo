...
import it.csi.sicee.siceebo.dto.main.CpHomeModel;
...
import it.csi.sicee.siceebo.presentation.siceebo.action.main.states.CpHomeScreenStates;
...
@Validation()
@Conversion()
public class CpHomeAction extends AbstractCPAction<CpHomeModel> implements Preparable, ModelDriven<CpHomeModel> {
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.main.CpHomeModel.class;
	}
