...
import it.csi.sicee.siceebo.dto.ricercaace.CpAnnullaAceModel;
...
import it.csi.sicee.siceebo.presentation.siceebo.action.ricercaace.states.CpAnnullaAceScreenStates;
...
/**
 * CpAnnullaAceAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpAnnullaAceAction extends AbstractCPAction<CpAnnullaAceModel>
		implements
			Preparable,
			ModelDriven<CpAnnullaAceModel> {
	 ...
	 * strato di business.
	 */
	private CpAnnullaAceModel model;
	 ...
	 * strato di business.
	 */
	public CpAnnullaAceModel getModel() {
		return model;
	}
	...
	public void setModel(CpAnnullaAceModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpAnnullaAce";
	...
	public Class modelClass() {
		return it.csi.sicee.siceebo.dto.ricercaace.CpAnnullaAceModel.class;
	}
	...
	public String handleBtnAvanti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercaace", "cpannullaace", "btnAvanti", "CLICKED");
	...
	public String handleBtnSostituzioni_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("ricercaace", "cpannullaace", "btnSostituzioni", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1335177092) ENABLED START*/
